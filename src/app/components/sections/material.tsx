    ...
    <section className="py-20 bg-white overflow-hidden">
      ...
      >
        {tripledMaterials.map((material, i) => (
          <div
            key={i}
            className="bg-white border border-gray-200 shadow-md rounded-2xl p-4 flex-shrink-0 w-[280px]"
            style={{ minWidth: "280px" }}
          >
            <div className="relative w-full pb-[133.33%] mb-4 rounded-xl overflow-hidden">
              <Image
                src={material.image}
                alt={material.title}
                fill
