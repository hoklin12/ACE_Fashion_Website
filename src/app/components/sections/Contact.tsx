      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Ready to outfit your team? Contact us for custom uniform solutions.
          </p>
        </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <a
                      href="mailto:sales@aceuniform.co"
                      className="text-lg font-medium text-gray-900 hover:text-blue-600 transition mt-1 block"
                    >
                      sales@aceuniform.co
                    </a>
                  </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <a
                      href="https://www.google.com/maps?q=51+Bukit+Batok+Crescent+%2306-07,+Unity+Centre,+Singapore+658077"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-lg font-medium text-gray-900 mt-1 hover:text-blue-600 transition block"
                    >
                      51 Bukit Batok Crescent #06-07
                    </a>
